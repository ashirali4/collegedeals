...
class SingleBrandView extends StatefulWidget {
  ...
  SingleBrandView(this.object);
}

class _SingleServiceViewState extends State<SingleBrandView> {
  Future<SingleBrandDetails> branddetails;
  MyApi api=new MyApi();
  @override
  Widget build(BuildContext context) {
    branddetails=api.singlebrandview(widget.object.link);
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
          child: Container(
            ...
            child: Padding(
              ...
              child:new FutureBuilder<SingleBrandDetails>(
                future: branddetails, // a Future<String> or null
                builder: (BuildContext context, AsyncSnapshot<SingleBrandDetails> snapshot) {
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: new FlatButton(
                                      ...
                                      onPressed:(){
                                        String link=snapshot.data.response[0].linkOrCouponValue;
                                        print(link);
  ...
  Widget sectionlist(SingleBrandDetails details){
    return Column(
      children: [
        Padding(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Expanded(
                                      flex: 4,
                                      child: Text(details.response[0].tagLine,
                                        style: TextStyle(
              ...
              child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        child: Text(details.response[0].description,
                          maxLines: 8,
                          style: TextStyle(
                            color: Color(0xff1D262C).withOpacity(.5),
                            fontSize: 14,
