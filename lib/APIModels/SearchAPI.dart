...
//
//     final searchBrands = searchBrandsFromJson(jsonString);

import 'dart:convert';

SearchBrands searchBrandsFromJson(String str) => SearchBrands.fromJson(json.decode(str));

String searchBrandsToJson(SearchBrands data) => json.encode(data.toJson());
...
class SearchBrands {
  ...
  factory SearchBrands.fromJson(Map<String, dynamic> json) => SearchBrands(
